...
const techStack = [
  ...
  {
    langImage: "assets/images/Angular.png",
    langName: "Angular",
    langDesc: "<li>Angular is a TypeScript-based free and open-source single-page web application framework. It is developed by Google and by a community of individuals and corporations. Angular is a complete rewrite from the same team that built AngularJS</li>",
  },
  {
    langImage: "assets/images/Mysql.png",
    langName: "MySql",
    langDesc: "<li>MySQL is an open-source relational database management system. Its name is a combination of <b>My</b>, the name of co-founder Michael Widenius's daughter My, and <b>SQL</b>, the acronym for Structured Query Language.</li>",
  },
  {
    langImage: "assets/images/TS.png",
    langName: "TypeScript ",
    langDesc: "<li>TypeScript is a free and open-source high-level programming language developed by Microsoft that adds static typing with optional type annotations to JavaScript. It is designed for the development of large applications and transpiles to <b>JavaScript</b></li>",
  },
  // {
